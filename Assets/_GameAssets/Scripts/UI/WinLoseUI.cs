...
public class WinLoseUI : MonoBehaviour
{
    ...
    public void OnGameWin()
    {
        ...
        _winPopupTransform.transform.DOScale(1.5f, _animationDuration).SetEase(Ease.OutBack);
    }
    ...
    public void OnGameLose()
    {
        ...
        _blackBackgroundImage.DOFade(0.8f, _animationDuration).SetEase(Ease.Linear);
        _losePopupTransform.transform.DOScale(1.5f, _animationDuration).SetEase(Ease.OutBack);
    }
}
